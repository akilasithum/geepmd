...
public class BioChemicalQ1 {

    private int bioChemicalQId;
    ...
    public int getBioChemicalQId() {
        return bioChemicalQId;
    }

    public void setBioChemicalQId(int bioChemicalQId) {
        this.bioChemicalQId = bioChemicalQId;
    }
